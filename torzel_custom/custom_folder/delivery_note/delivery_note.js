...
async function populate_items_from_barcode(frm, barcode_doc, bigbox_doc) {
    if (barcode_doc) {
        ...
        row.qty = barcode_doc.dispatched_gross_weight - barcode_doc.dispatched_tare_weight;
        ...
        row.custom_gross_weight = barcode_doc.dispatched_gross_weight;
        row.custom_tare_weight = barcode_doc.dispatched_tare_weight;
